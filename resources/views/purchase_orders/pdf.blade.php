...
<div class="rightbox">
<div class="so">P/O No. : {{ $purchaseOrder->po_number }} &nbsp;&nbsp; Date : {{ $purchaseOrder->order_date ? $purchaseOrder->order_date->format('d-m-Y') : $purchaseOrder->created_at->format('d-m-Y') }}</div>
<br><br>
...
@if($purchaseOrder->salesOrder && $purchaseOrder->salesOrder->quotation && $purchaseOrder->salesOrder->quotation->items)
@foreach($purchaseOrder->salesOrder->quotation->items as $index => $item)
<tr>
...
<td class="center">{{ $item->delivery_time ?? ($purchaseOrder->expected_date ? $purchaseOrder->expected_date->format('d-m-Y') : 'N/A') }}</td>
<td class="center">{{ $item->hsn_code ?? '90191090' }}</td>
...
<td class="right">{{ number_format($purchaseOrder->total_amount, 2) }}</td>
<td class="right">0.00</td>
<td class="right">0.00</td>
<td class="right">{{ number_format($purchaseOrder->total_amount * 0.18, 2) }}</td>
</tr>
<tr>
<td><b>Total</b></td>
<td class="right"><b>{{ number_format($purchaseOrder->total_amount, 2) }}</b></td>
<td class="right"><b>0.00</b></td>
<td class="right"><b>0.00</b></td>
<td class="right"><b>{{ number_format($purchaseOrder->total_amount * 0.18, 2) }}</b></td>
</tr>
</table>
...
<td class="right"><b>{{ number_format($purchaseOrder->total_amount * 1.18, 2) }}</b></td>
</tr>
<tr>
<td colspan="2">
<b>Amount In Word:</b>
{{ ucwords(\App\Models\Quotation::amountInWords($purchaseOrder->total_amount * 1.18)) }} Rupees Only
</td>
</tr>
</table>
</div>
